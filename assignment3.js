...
----------------------------------------------------
Value of area ( 0 < number <=10^9 )    Output (number)
----------------------------------------------------
100                                     50
15                                      7.5
2060                                    1030
...
/** Problem -01 ( Divide the Asset ) */
//var area = 800; <<== এই কমেন্ট উঠায় দিতে হবে
//write your code here

/** Problem -01 ( Divide the Asset ) */
var area = 800;
//write your code here
var sharePerBrother=area/2;
console.log(sharePerBrother);
...
----------------------------------------------------
Value of money(0 < number <=10^9 )  Output (string) 
----------------------------------------------------
45000                               Laptop
10000                               Cycle
9999                                Chocolate 
...
নিচের কোড স্নিপেট টি কপি করো ,  প্রোগ্রাম টি কে  কমপ্লিট করো  এবং console.log করে আউটপুট দেখাও
/** Problem -02 ( Cycle or Laptop ) */
//var money = 10000; <<== এই কমেন্ট উঠায় দিতে হবে
//write your code here
...
/** Problem -03 ( Medicine Planner ) */
// var lastDay = 11 ;  <<== এই কমেন্ট উঠায় দিতে হবে
//write your code here
...
if(fileName[0]=="#"){
    console.log("Store");
}else if(fileName.slice(fileName.indexOf("."),(fileName.length))==".pdf"){
    console.log("Store");
}else if (fileName.slice(fileName.indexOf("."),(fileName.length))==".docx"){
    console.log("Store");
}else{
    console.log("Delete");
...
{ 
name: "jhankar", 
roll: 1014,                         jhankar1014.cse@ph.ac.bd
department: "cse"  
}
----------------------------------------------------
{ 
name: "monu", 
roll: 99,                           monu99.eee@ph.ac.bd
department: "eee"  
}
----------------------------------------------------
{ 
name: "mewo", 
roll: 96,                           mewo96.cse@ph.ac.bd
department: "cse"  
}
----------------------------------------------------
...
----------------------------------------------------
startingSalary          experience          Output
(0< number <=106)       (0< number <=50)    (up to 2 Decimal)
----------------------------------------------------
45000                   30                  194487.41
15000                   3                   17364.38
30000                   40                  211199.66
