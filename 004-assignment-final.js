...
function  onlyCharacter( str ) {
    if(typeof str !=='string'){
        ...
        let finalResult=newStr.toUpperCase();
        return finalResult;
    }
}

//const result =onlyCharacter(" $ %   & h e llo wor  2025 ld" );
//console.log(result);
*/
...
------------------------------------------------------------
{ name: "Brazil", foul: 5,              Brazil
cardY: 1, cardR: 0 },
{ name: "Argentina", foul: 7,
cardY: 0, cardR: 0 }
------------------------------------------------------------
{ name: "Germany", foul: 12,            Tie
cardY: 0, cardR: 0 },
{ name: "Sweden", foul: 7,
cardY: 4, cardR: 1 }

------------------------------------------------------------
{ name: "Germany", foul: 10,            Germany
cardY: 1, cardR: 1 },
{ name: "France", foul: 10, 
cardY: 2, cardR: 1 }
------------------------------------------------------------
{ name: "Germany", foul: 10,            Invalid
cardY: 1, cardR: 1 },"France"
------------------------------------------------------------
...
function  bestTeam( player1, player2){
    if(typeof player1 !=='object' || typeof player2 !=='object'){
        ...
        let pl1Score=player1.foul+player1.cardY+player1.cardR;
        let pl2Score=player2.foul+player2.cardY+player2.cardR;
...
let arr5=[1 , "4" , 4];
const result5=resultReport(arr5);
console.log(result5);
*/
...
let arr5=100;
let arr5=[99];
let arr5=[99, 87, 67, 12 ,87];
let arr5=[98, 87, 67, 91, 92, 33, 87];
let arr5=[1 , "4" , 4];
